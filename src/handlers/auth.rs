...
use crate::models::user::{
    ForgotPasswordRequest, ForgotPasswordResponse, LoginRequest, LoginResponse, RegUser, ResetPasswordRequest, UserLogreg, VerificationResponse, VerifyEmailRequest

};
use std::fmt::Write;
use crate::models::user::VerificationQuery;
...
pub async fn verify_email(db: web::Data<Surreal<Client>>, query: web::Query<VerifyEmailRequest>) -> HttpResponse {
                        ...
                        match update_result {
                            ...
                            Err(e) => {
                                return HttpResponse::InternalServerError().json(ApiResponse::<()> {
                                    status: "error".to_string(),
                                    message: format!("Error updating verification status: {}", e),
                                    data: None,
                                });
                            }
                        }
